...
<Card color="#7e0808" horizontal cta="You are currently viewing documentation for version 1.0, which is no longer actively updated. Please refer to the latest version (2.1) for the most up-to-date information.">
  You are currently viewing documentation for version 1.0, which is no longer actively updated. Please refer to the latest version (2.1) for the most up-to-date information.
</Card>
...
1. Open **Start Menu**, type **Windows Features**, and click **Turn Windows features on or off**. 
